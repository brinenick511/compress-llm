...
if __name__ == '__main__':
    ...
    if args.step == 1:
        ...
        if args.save_path is not None:
            ...
            torch.save(model.state_dict(), args.save_path + "/" + args.model.replace("/", "_").replace("-", "_") +'_whitening_only_' + str(args.ratio) + '.pt')   # fp32
    elif args.step == 2:
        model, tokenizer = get_model_from_huggingface(model_id=args.model)
    ...
    elif args.step == 4 or args.step ==5:
